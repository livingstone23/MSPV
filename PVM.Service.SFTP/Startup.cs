...
using PVM.Service.SFTP.DbContexts;
using PVM.Service.SFTP.Utility;
using System.Text;
...
namespace PVM.Service.SFTP
{
    public class Startup
    {
        ...
        public void ConfigurationServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PVM.Service.SFTP", Version = "v1" });
                c.SwaggerDoc("v2", new OpenApiInfo { Title = "PVM.Service.SFTP", Version = "v2" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "PVM.Service.SFTP v1");
                    c.SwaggerEndpoint("/swagger/v2/swagger.json", "PVM.Service.SFTP v2");
                });
            }
